...
def generate_xml(name,split_lines,img_size,class_ind):
    ...
    # 将DOM对象doc写入文件
    f = open('/home/maozezhong/Desktop/交通卡口车辆信息精准识别/car-recoganization-competition/darknet/scripts/VOCdevkit/VOC2018/Annotation/'+name+'.xml','w')
...
if __name__ == '__main__':
    class_ind=('car')
    cur_dir=os.getcwd()
    txt_dir='/home/maozezhong/Desktop/交通卡口车辆信息精准识别/data/train_1w_txt'
    for parent, dirnames, filenames in os.walk(txt_dir): # 分别得到根目录，子目录和根目录下文件   
        for file_name in filenames:
            ...
            img_name=name+'.jpg' 
            img_path='/home/maozezhong/Desktop/交通卡口车辆信息精准识别/data/train/'+img_name # 路径需要自行修改            
